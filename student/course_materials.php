...
if(empty($_SESSION['student']) && ($_SESSION['student_grade_id'])) {
          ...
          <div class="row">
              ...
              <div class="card">
                ...
                <div id="accordion<?php echo $year->id; ?>" class="mr-4 ml-4"> 
                    <?php
                      $course_materials = $fetch_data->getCourseMaterialsForStudent($_SESSION['student_grade_id']);
                    ?>
                    <div class="accordion">
                                        ...
                                        <?php foreach($course_materials as $new): ?>
                                          <?php if(($new->academic_id == $year->id) && ($new->semester_id == $sem->id)): ?>
                                            <tr>
                                              ...
                                              <td>
                                                <a href="../uploads/course_materials/<?php echo $new->file; ?>" class="text-warning"><i class="fa fa-download" download=""></i></a>
                                              </td>
                                            </tr>
                                          <?php endif; ?>
                                        <?php endforeach; ?>
