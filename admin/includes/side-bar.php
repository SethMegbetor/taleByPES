...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <li class="<?php echo $active_page->activePage('evaluation_report.php'); ?>"><a class="nav-link" href="evaluation_report.php"><i data-feather="edit"></i><span>Faculty Evaluation</span></a></li>
        <li class="<?php echo $active_page->activePage('attendance.php'); ?>"><a class="nav-link" href="attendance.php"><i data-feather="check-square"></i><span>Attendance Report</span></a></li>
